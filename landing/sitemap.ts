...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: { path: string; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }[] = [
    ...
    { path: '/blog/ai-assistant-guide', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/blog/notes-plugin-guide', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/blog/pin-lock-guide', changeFrequency: 'monthly', priority: 0.7 },
