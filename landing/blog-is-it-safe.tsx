        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <section style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: 13, marginTop: 12 }}>
              Версия 2.7.0 · Бесплатно · <Link href="/download/macos" style={{ color: 'inherit' }}>macOS</Link> · <Link href="/download/linux" style={{ color: 'inherit' }}>Linux</Link> · <Link href="/privacy" style={{ color: 'inherit' }}>Политика конфиденциальности</Link>
            </p>
          </section>
        </div>
      </div>
