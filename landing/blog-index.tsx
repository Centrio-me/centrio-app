...
const POSTS = [
  ...
  { slug: 'ai-assistant-guide', tag: 'Гид', color: '#a5b4fc', title: 'AI-ассистент в Centrio: как настроить и что он умеет', desc: 'Три режима подключения — свой ключ, локальная модель или готовая нейросеть Pro — и что реально удобно спрашивать, не выходя из мессенджеров.' },
